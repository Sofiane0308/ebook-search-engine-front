...
import { List, Card, Row, Col, Skeleton, Divider, Select, Typography,Space,Image } from 'antd';
...
function Results(props) {
    ...
    return (
        <div>
            ...
            <Col flex='300px'><Divider orientation="left">You may also like</Divider></Col>
            </Row>
        </div>
    );
}
